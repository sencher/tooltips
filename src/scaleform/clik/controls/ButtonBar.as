...
//            Cc.green2cw(this, DebugUtils.set("set autoSize", _autoSize, value, name));
        _autoSize = value;
        for (var i:Number = 0; i < _renderers.length; i++) {
...
//            Cc.yellowcw(this, DebugUtils.set("set buttonWidth", _buttonWidth, value, name));
        _buttonWidth = value;
        invalidate();
    }
...
//                if(DebugUtils.isInterestingSpriteClass(this)) Cc.grasscw(this, "draw", _width, _height);
...
//            Cc.green2cw(this, "updateRenderers", name);
        var w:Number = 0;
        var h:Number = 0;
        ...
        for (var i:uint = 0; i < _dataProvider.length && overflowIndex == -1; i++) {
            ...
            if (i < _renderers.length) {
                ...
                renderer = createRenderer(_dataProvider.requestItemAt(i));
    ...
    protected function createRenderer(data:Object):Button {
        var renderer:Button = new _itemRendererClass();
        return renderer;
    }
