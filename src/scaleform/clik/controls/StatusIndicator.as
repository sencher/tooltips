/**
    The StatusIndicator component displays the status of an event or action using its timeline as the visual indicator.
    The value of the StatusIndicator will be interpolated with the minimum and maximum values to generate a frame number that will be played in the component’s timeline.
    Since the component’s timeline is used to display the status, it provides absolute freedom in creating innovative visual indicators.
...
//            Cc.green2cw(this, "updatePosition", enabled,"currentFrame", currentFrame, "name", name);
            if (!enabled) {
                return;
            }
...
//            Cc.green2("percent",percent,"nextFrame",nextFrame, "currentFrame", currentFrame);
//            if(parent) Cc.green2("parent.currentFrame",MovieClip(parent).currentFrame);
//            if(parent && parent.parent) Cc.green2("parent.parent.currentFrame",MovieClip(parent.parent).currentFrame);
    
            if (currentFrame != nextFrame) {
//                Cc.redc(this, "gotoAndStop", nextFrame);
