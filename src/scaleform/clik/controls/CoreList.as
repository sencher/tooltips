...
public class CoreList extends UIComponent {
    ...
    public function set itemRendererName(value:String):void {
        ...
        if (classRef != null) {
            ...
            Ct.red2cw(this, "Error: " + this + ", The class " + value + " cannot be found in your library. Please ensure it is there.");
        }
    }
...
//        if (interesting) Cc.green2cw(this, DebugUtils.set("CoreList.set dataProvider", _dataProvider, value, name));
        _dataProvider = value;
        if (_dataProvider == null) {
            return;
        }
    ...
    protected function drawRenderers(total:Number):void {
        if (_itemRenderer == null) {
            Ct.red2cw(this, "Renderer class not defined.");
            return;
        }
    ...
    protected function createRenderer(index:uint):IListItemRenderer {
        ...
        if (renderer == null) {
            Ct.red2cw(this, "Renderer class could not be created:", _itemRenderer);
            return null;
        }
