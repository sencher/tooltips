...
package scaleform.clik.managers {
    ...
    public class PopUpManager {
        ...
        public static function init(stage:Stage):void {
			...
			_defaultPopupCanvas.name = "popups";
    ...
    // Public Methods:
        ...
        public static function clear():void{
            while(_defaultPopupCanvas.numChildren){
                _defaultPopupCanvas.removeChildAt(0);
            }
            if(_modalMc && _modalMc.parent){
                _modalMc.parent.removeChild(_modalMc);
                _modalMc=null;
            }
        }
