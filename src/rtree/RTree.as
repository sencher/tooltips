...
package rtree  {
    ...
    */
    public class RTree {
      ...
      private static const ENTRY_STATUS_UNASSIGNED:int = 1;
        ...
        /** @private */
      internal var maxNodeEntries:int;
      ...
      public function RTree():void {
        ...
        for(var i:int=0;i<this.maxNodeEntries; i++) this.initialEntryStatus[i] = RTree.ENTRY_STATUS_UNASSIGNED;
    ...
    */ 
      public function addCube(r:Cube,id:int,level:int=1):void {
        ...
        if (RTree.INTERNAL_CONSISTENCY_CHECKING) this.checkConsistency(rootNodeId, treeHeight, null)
    ...
    */
      public function deleteCube(r:Cube, id:int):Boolean {
    ...
    */
      public function intersects(r:Cube):Array {
    ...
    * @return An array with all cube Ids than intersect the input cube
    */
      public function contains(r:Cube):Array {
    ...
    */
      public function getBounds():Cube {

        var bounds:Cube = null
      ...
      private function getNode(index:int):RTreeNode {
      ...
      */
      private function splitNode(n:RTreeNode, newRect:Cube, newId:int):RTreeNode {
      ...
      */
      private function pickSeeds(n:RTreeNode, newRect:Cube, newId:int, newNode:RTreeNode):void {
        ...
        // Find extreme rectangles along all dimension. Along each dimension,
          ...
          for (var d:int = 0; d < Cube.DIMENSIONS; d++) {
      ...
      */
      private function recursiveIntersects(destiny:Array, r:Cube, n:RTreeNode):void {
        for (var i:int = 0; i < n.entryCount; i++) {
          if (r.intersects(n.entries[i])) {
            if (n.isLeaf()) {
      ...
      */
      private var oldRectangle:Cube = new Cube(0, 0, 0, 0, 0, 0)
      ...
      */
      private function chooseNode(r:Cube, level:int):RTreeNode {
        ...
        while (true) {
          ...
          for (var i:int = 1; i < n.entryCount; i++) {
            var tempRectangle:Cube = n.getEntry(i)
      ...
      */
      private function checkConsistency(nodeId:int, expectedLevel:int, expectedMBR:Cube):void {
        ...
        var calculatedMBR:Cube = calculateMBR(n)
        ...
        if (expectedMBR != null && n.mbr==(expectedMBR)) {
          trace("Error: RTreeNode " + nodeId + " MBR using same cube object as parent's entry");
        }
      ...
      */
      private function calculateMBR(n:RTreeNode):Cube {
          var rect:Cube = n.entries[0]
        var mbr:Cube = new Cube(rect.min[0], rect.min[1], rect.min[2], rect.max[0], rect.max[1], rect.max[2])
