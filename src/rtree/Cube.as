...
package rtree  {
    ...
    /**
    * <p>The Cube is the data type used in our rTree. Cubes can be inserted and searched for efficiently.</p>
    ...
    */
    public class Cube {
      ...
      * @param z2 (see x2)
      */
      public function Cube(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):void {
