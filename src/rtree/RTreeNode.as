...
package rtree  {
    ...
    */
    public class RTreeNode {
      ...
      // Constructor
      public function RTreeNode(nodeId:int, level:int, maxNodeEntries:int):void {
        this.nodeId = nodeId
        this.level = level
        this.entries = []
        this.ids = []
      ...
      public function addEntry(r:Cube, id:int):void {
      ...
      // Add entry to the node
      public function addEntryNoCopy(r:Cube, id:int):void {
        this.ids[this.entryCount] = id
      ...
      public function findEntry(r:Cube,id:int):int {
      ...
      public function deleteEntry(i:int,minNodeEntries:int):void {
          ...
          var deletedRectangle:Cube = this.entries[i]
        this.entries[i] = null
          if(i!=lastIndex) {
      ...
      public function recalculateMBR(deletedRectangle:Cube):void {

        if(this.mbr.edgeOverlaps(deletedRectangle)) {

            var n:Cube = this.entries[0]
      ...
      public function getEntry(index:int):Cube {
