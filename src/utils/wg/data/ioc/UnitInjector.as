...
import utils.wg.utils.data.ioc.*;
...
//			Cc.logcw(this, "UnitInjector", arguments);
    ...
    public function fill(interfaceClass:Class, source:Object):void {
        //Cc.logcw(this, "fill", interfaceClass, source);
...
//			Cc.logcw(this, "inject", arguments);
        _target = target;
        if (!target) {
...
//			Cc.logcw(this, "injectRecurrent", arguments);
        var prop:String;
        var xmlSource:XML = describeType(source);
//			Cc.logcw(this, "xmlSource", xmlSource);
        ...
        if (variables.length() + accessors.length() > 0) {
            ...
            source = newSource;
//				Cc.logcw(this, "newSource", newSource);
        }
        
        for (prop in source) {
//				Cc.logcw(this, "prop", prop);
