...
public class Utils {
    ...
    public static function alignToDisplayObjectHorizoltally(alignedObj:DisplayObject, staticObj:DisplayObject):void{
        ...
        //Cc.logcw("alignToDisplayObjectHorizoltally", alignedObj, alignedMetrics.width, alignedCenter,"///",staticObj,staticMetrics.width,staticCenter);
        //Cc.log(alignedObj.x, staticCenter, -alignedCenter);
