package utils.wg.utils.hyperlink
{
			...
			return function () {
				switch (link) {
					case HyperlinkConstants.VIDEO_CONQUEST:
						tryToCallBrowserPage(BrowserTagID.TUTORIAL); break;
					case HyperlinkConstants.VIDEO_GUIDE:
						tryToCallBrowserPage(BrowserTagID.DEFAULT); break;
					case HyperlinkConstants.BROWSER_GUIDE:
						tryToCallBrowserPage(BrowserTagID.GUIDE); break;
					case HyperlinkConstants.VIDEO_FIGHTERS:
						tryToCallBrowserPage(BrowserTagID.TYPE_LIGHT); break;
					case HyperlinkConstants.VIDEO_ASSAULT:
						tryToCallBrowserPage(BrowserTagID.TYPE_ATTACKER); break;
					case HyperlinkConstants.VIDEO_NAVY:
						tryToCallBrowserPage(BrowserTagID.TYPE_NAVY); break;
					case HyperlinkConstants.VIDEO_HFIGHTERS:
						tryToCallBrowserPage(BrowserTagID.TYPE_HEAVY); break;
					case HyperlinkConstants.VIDEO_BOMBERS:
						tryToCallBrowserPage(BrowserTagID.TYPE_BOMBER); break;
					case HyperlinkConstants.RESEARCH_TREE:
						HangarModel.instance.gotoResearchTree(); break;
					case HyperlinkConstants.TAB_MAINTENANCE:
						HangarModel.instance.gotoMaintenance(); break;
					case HyperlinkConstants.TAB_MODULES:
						HangarModel.instance.gotoModules(); break;
					case HyperlinkConstants.TAB_CUSTOMIZATION:
						HangarModel.instance.gotoCustomization(); break;
					case HyperlinkConstants.TAB_CREW:
						HangarModel.instance.gotoCrew(); break;
					case HyperlinkConstants.ACHIEVEMENTS:
						HangarModel.instance.gotoMedals(); break;
					case HyperlinkConstants.STATISTICS:
						HangarModel.instance.gotoAchievements(); break;
					case HyperlinkConstants.SEARCH_SQUAD:
						HangarModel.instance.gotoSquad(); break;
					case HyperlinkConstants.BARRACKS:
						HangarModel.instance.gotoBarracks(); break;
					case HyperlinkConstants.CONTACT_LIST:
						AccountModel.instance.chatModel.openContactList(); break;
					case HyperlinkConstants.CURRENT_QUESTS:
						HangarModel.instance.ui.showQuestWindow(QuestFilterConst.CURRENT_QUESTS); break;
					case HyperlinkConstants.BUY_PREMIUM:
						HangarModel.instance.ui.showBuyPremiumWindow(); break;
					case HyperlinkConstants.SUPPLY_SERVICE:
						HangarModel.instance.ui.showTicketsWindow(); break;
					case HyperlinkConstants.GOLD_EXCHANGE:
						HangarModel.instance.ui.showExchangeGoldWindow(); break;
					case HyperlinkConstants.EXP_EXCHANGE:
						HangarModel.instance.ui.showExchangeExpWindow(); break;
					case HyperlinkConstants.BATTLE_ORDERS:
						EventPipe.dispatcher.dispatchEvent(new ContextMenuEvents(ContextMenuEvents.SHOW_USER_HANGAR_MENU)); break;
					case HyperlinkConstants.CREW_PROFILE:
						HangarModel.instance.gotoCrew();
						HangarModel.instance.gotoCrewProfile(); break;
					case HyperlinkConstants.PREMIUM_SHOP:
						HangarModel.instance.common.premiumShop(); break;
					case HyperlinkConstants.STORAGE:
						HangarModel.instance.gotoStorage(); break;
					case HyperlinkConstants.TROPHY_TEAM:
						HangarModel.instance.gotoTrophyTeam(); break;
					case HyperlinkConstants.PROGRESSION_SPECIALIST:
						HangarModel.instance.ui.showProgressionWindow(AccountModel.instance.playerModel.selectedPlaneID, PlaneStages.SPECIALIST); break;
					case HyperlinkConstants.WEB_ACHIEVEMENTS:
						HangarModel.instance.common.showAchievements(); break;
				}
			}
