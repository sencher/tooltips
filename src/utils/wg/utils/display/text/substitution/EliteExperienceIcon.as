package utils.wg.utils.display.text.substitution
{
	...
	public dynamic class EliteExperienceIcon
	{
		private static var _ids:uint;
		public static const DEFAULT_SUBSTRING:String = "{exp_elite}";
		static private const ICON_BASELINE_Y:Number = 10;
		
		public function EliteExperienceIcon(substring:String = null)
		{
			this["image"] = new (getDefinition("iconComCurrencyExpElite"))() as BitmapData;
