package utils.wg.utils.display.text.substitution
{
    ...
    public dynamic class CertificatesSmallIcon
    {
        private static var _ids:uint;
        public static const DEFAULT_SUBSTRING:String = "{crt_sm}";
        static private const ICON_BASELINE_Y:Number = 16;
        
        public function CertificatesSmallIcon(substring:String = null, yOffset:int = 0)
        {
            this["image"] = new (getDefinition("iconCertificateSmall_up"))() as BitmapData;
