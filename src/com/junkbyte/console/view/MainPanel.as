...
public class MainPanel extends ConsolePanel {
    ...
    private var _scrollStates:Dictionary = new Dictionary();
...
//            _needUpdateTrace = isActiveChannel(ch);
    ...
    private function updateFull():void {
        ...
        if (_needRestoreScrollState) {
            ...
            delete _scrollStates[channelsKey];
        }
...
//            trace("skip");
        ...
        if (_scrollStates[channelsKey] && _scrollStates[channelsKey].scrollPercent < 1) {
            updateWithScroll()
        } else {
            updateToBottom();
        }
