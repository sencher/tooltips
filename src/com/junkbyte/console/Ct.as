...
public class Ct {
    ...
    public static function red2cj(channel:*, ...strings):void {
        strings.unshift(channel);
        Cc.red2cj.apply(null, strings);
    }
    
    public static function red2wj(...strings):void {
        Cc.red2wj.apply(null, strings);
    }
